...
public class WidgetConfiguration extends Activity 
{
	...
	public static final String WIDGET_CONF_FILE = "Book_Widget_conf";
	...
	private void updateConfigurationStatusPrefs(boolean configurationStatus)
	{
		...
		SharedPreferences widgetConfiguration = getSharedPreferences(WIDGET_CONF_FILE, 0);
	...
	public static boolean getConfigurationStatusPrefs(Context context)
	{
		...
		SharedPreferences widgetConfiguration = context.getSharedPreferences(WIDGET_CONF_FILE, 0);

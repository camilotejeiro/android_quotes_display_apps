...
public class WidgetConfiguration extends Activity 
{
	...
	public static final String NOTES_WIDGET_CONF_FILE = "Book_Widget_conf";
	...
	private void updateConfigurationStatusPrefs(boolean configurationStatus)
	{
		...
		SharedPreferences widgetConfiguration = getSharedPreferences(NOTES_WIDGET_CONF_FILE, 0);
	...
	public static boolean getConfigurationStatusPrefs(Context context)
	{
		...
		SharedPreferences widgetConfiguration = context.getSharedPreferences(NOTES_WIDGET_CONF_FILE, 0);
